...
export default function EditBlogger() {
  ...
  useEffect(() => {
    const allBloggers = JSON.parse(localStorage.getItem("blogger")) || [];
  ...
  const handleSave = () => {
    ...
    localStorage.setItem("blogger", JSON.stringify(updatedBloggers));
    navigate("/blogger"); // go back to blogger list
  };
    ...
    <div className="min-h-screen bg-black p-6">
      <div className="max-w-4xl mx-auto bg-stone-900 p-6 rounded-lg">
        ...
        <div className="flex justify-end gap-4 mt-6">
          <Button variant="outline" onClick={() => navigate("/blogger")} className={undefined} size={undefined}>
            Cancel
          </Button>
