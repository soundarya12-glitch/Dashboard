...
export default function Newcontact() {
 ...
 const handleSave = () => {
  ...
  onChange={(v: any) => setContact({ ...contact, firstName: v })}
...
/>
          ...
          <Input label="Last Name"
            ...
            onChange={(v: any) => setContact({ ...contact, lastName: v })}
              className="w-full h-6 p-2 mt-3 bg-stone-600 text-white border border-gray-400 focus:border-pink-400"
          />

          <Input label="Middle Name"
            value={contact.middleName}
            onChange={(v: any) => setContact({ ...contact, middleName: v })}
              className="w-full h-6 p-2 mt-3 bg-stone-600 text-white border border-gray-400 focus:border-pink-400"
          />

          <Input label="User Address"
            value={contact.address}
            onChange={(v: any) => setContact({ ...contact, address: v })}
              className="w-full h-6 p-2 mt-3 bg-stone-600 text-white border border-gray-400 focus:border-pink-400"
          />

          <Input label="User ID"
            value={contact.userId}
            onChange={(v: any) => setContact({ ...contact, userId: v })}
              className="w-full h-6 p-2 mt-3 bg-stone-600 text-white border border-gray-400 focus:border-pink-400"
          />

          <Input label="Designation"
            value={contact.designation}
            onChange={(v: any) => setContact({ ...contact, designation: v })}
              className="w-full h-6 p-2 mt-3 bg-stone-600 text-white border border-gray-400 focus:border-pink-400"
          />
        </div>
