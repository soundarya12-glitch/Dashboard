...
export default function Editpermission() {
  ...
  useEffect(() => {
    const allContacts = JSON.parse(localStorage.getItem("blogger")) || [];
  ...
  const handleSave = () => {
    ...
    localStorage.setItem("blogger", JSON.stringify(updatedContacts));
    navigate("/Userpermission"); // go back to contacts list
  };
